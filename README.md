...
You can use the same certificate files on front-end and back-end, just copy the files as the [last topic](https://github.com/mybetspace/.github/new/main?readme=1#after-generate-the-certificate-for-both) says.
