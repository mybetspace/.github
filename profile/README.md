...
You can use the same certificate files on front-end and back-end, just copy the files as the [last topic](https://github.com/mybetspace/frontend/edit/master/README.md#after-generate-the-certificate-for-both) says.
